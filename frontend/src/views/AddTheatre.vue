...
<template>
  ...
  <div id="app">
    ...
    <div id="content">
        ...
        <input class="form-control" type="number" min="1" v-model="screenCount" id="screenCount" placeholder="Number of Screens">
          </div>
        ...
        <div class="form-group col-md-6" v-for="index in screenCountArray" :key="index">
          ...
          <input class="form-control" :id="'screenCapacity-' + index" type="number" min="1" v-model="screenCapacities[index - 1]">
        </div>
