...
class TheatreDataApi(Resource):
    ...
    def post(self):
        ...
        if theatre_exists:
            ...
            # Adding screens to the screens database with the corresponding theatre_id
...
class MoviesDataApi(Resource):
    ...
    # @jwt_required()
    @cache.cached(timeout=500)  # Cache this view for 500 seconds
    def get(self):
...
class ShowsApi(Resource):
    ...
    def get(self, theatre_id=None):
        if theatre_id:
            # Getting future shows of the given theatre
...
class EditShowApi(Resource):
    ...
    def delete(self, show_id):
        ...
        if show:
            ...
            # Deleting the show from the database
            db.session.delete(show)
